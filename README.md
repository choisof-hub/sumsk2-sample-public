...
本リポジトリは、社内システムからExcelファイルとして出力される出荷伝票データを読み込み、**納品先別・型式別に出荷数量を集計する業務支援ツール**の公開用サンプルです。
...
`shipping_tool_sample_screens.xlsx` は、実画面を直接公開せずに、**Excelのセル・罫線・結合セルでレイアウトを再構成した説明用モックアップ**です。
